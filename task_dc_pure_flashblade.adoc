...
[role="lead"]
Cloud Insights verwendet den Datensammler Pure Storage FlashBlade, um Inventar- und Performance-Daten von FlashBlade-Clustern zu erfassen, die Version 2 ihrer REST-API offenlegen
...
| Benutzername | Benutzername, der Cloud Insights-Administratoren hilft, sich zu merken, zu welchem Benutzer ihr API-Token gehört 
