...
Eine Unisphere for VMAX/PowerMax-Instanz verwaltet möglicherweise ein oder mehrere Symmetrix 3 oder höhere Speicher-Arrays – dieser Collector versucht standardmäßig, alle Arrays zu ermitteln.
