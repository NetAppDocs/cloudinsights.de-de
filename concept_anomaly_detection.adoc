...
image:Anomaly Detection Monitor Choice.png["Auswahl der Anomaly-Erkennung beim Erstellen eines Monitors, Breite=480"]
...
image:Anomaly Detection Monitor Conditions.png["Einstellen der Bedingungen für die Überwachung der Anomaly-Erkennung"]
