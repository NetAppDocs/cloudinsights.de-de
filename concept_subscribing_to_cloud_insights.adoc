...
Die Abonnementrechner geben Ihnen eine geschätzte monatliche Cloud Insights-Kosten basierend auf der Anzahl der verwalteten Einheiten, die Sie voraussichtlich benötigen. Die aktuellen Werte sind bereits ausgefüllt, und Sie können diese Werte anpassen, um Sie bei der Planung des geschätzten zukünftigen Wachstums zu unterstützen. Sie können die Werte für Infrastruktur, Kubernetes oder beides anpassen.
