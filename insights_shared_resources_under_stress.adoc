...
Cloud Insights zeigt eine Liste aller Workloads an, bei denen eine Sättigung erkannt wurde. Beachten Sie, dass Cloud Insights Workloads zeigt, bei denen mindestens eine _anspruchsvolle Ressource_ *oder* _betroffene Ressource_ erkannt wurde.
...
image:ResourceInsightDemanding.png["Diagramm mit anspruchsvollen Workloads"]
image:ResourceInsightImpacted-a.png["Betroffene Workload-Grafik"]
