...
** NFS-Protokoll Version 4.1 und früher
...
* • ONTAP persistenter Speicher wird von 9.15.1 unterstützt.
...
* Ein angehaltener Data Collector kann nicht gelöscht werden.
* Während der Pause sind die fpolicy-Einstellungen in ONTAP deaktiviert, aber nicht gelöscht. Bei der Wiederaufnahme werden die fpolicy-Einstellungen in ONTAP wieder aktiviert.
