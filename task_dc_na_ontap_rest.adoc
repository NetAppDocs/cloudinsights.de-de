...
* Sie müssen Zugriff auf ein Benutzerkonto mit der erforderlichen Zugriffsebene haben
* Zu den Kontodetails gehören Benutzername und Passwort.
* Anforderungen an den Hafen: 443
* Kontoberechtigungen:
+
** Cloud Insights stellt Leseanforderungen, aber für die Registrierung beim ONTAP-Array sind einige Schreibberechtigungen erforderlich. Siehe Hinweis über Berechtigungen unten.
