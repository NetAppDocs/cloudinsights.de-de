...
[role="lead"]
Bevor Sie mit Cloud Insights arbeiten können, müssen Sie sich im Portal *NetApp BlueXP* anmelden. Wenn Sie bereits über ein BlueXP Login verfügen, können Sie Cloud Insights in wenigen schnellen Schritten kostenlos testen.
...
Um sich von Cloud Insights abzumelden, klicken Sie auf Ihren *Benutzername* und wählen *Abmelden*. Sie werden zurück zum geführt link:https://docs.netapp.com/us-en/bluexp-setup-admin/task-logging-in.html["BlueXP Anmeldung"] Bildschirm.
