...
....
Überprüfen Sie unbedingt den Abschnitt Berechtigungen der link:/cloudinsights/task_add_collector_svm.html["Konfiguration des ONTAP SVM Data Collector"] Zu.
