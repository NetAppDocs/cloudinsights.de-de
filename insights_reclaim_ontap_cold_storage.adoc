...
image:Cold_Data_Example_1.png["Beispiel Für Kalte Daten"]
...
+
Die Fabric Pool-Lösung von NetApp verschiebt selten genutzte Daten automatisch auf kostengünstigen Cloud-Storage, wodurch die Effizienz Ihrer Performance-Tiers erhöht und Remote-Datensicherung ermöglicht wird.



Das Diagramm und die Tabelle bieten zusätzliche Trendinformationen sowie die Möglichkeit, detaillierte Informationen zu den einzelnen Workloads zu erhalten.
