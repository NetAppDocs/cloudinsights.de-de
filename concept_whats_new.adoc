...
Sie haben uns gebeten, Ihnen bei der Installation des Agenten für Windows, Linux und MacOS Prüfsummenwerte zur Verfügung zu stellen, und das ist eine großartige Idee. Hier sind sie also:
