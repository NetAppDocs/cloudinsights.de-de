...
* Whitelisting *allowed Dateitypen*: Wenn ein Ransomware-Angriff für eine bekannte Dateierweiterung erkannt wird, kann diese Dateierweiterung auf die Whitelisting gesetzt werden, um unnötige Warnungen zu vermeiden. - link:/ws_allowed_file_types.html["Weitere Informationen"]
