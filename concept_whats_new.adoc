...
=== Kubernetes PV-Daten melden

Von Cloud Insights gesammelte Informationen zu persistentem Volume (Kubernetes Persistent Volume, PV) können jetzt für die Berichterstellung verwendet werden. Dies ermöglicht Chargeback, Trendanalysen, Prognosen, TTF-Berechnungen, Weitere Geschäftsberichte zu Kennzahlen für Kubernetes-Cluster, Namespaces, Workloads und mehr.
...
* https://[] (Hinweis: Sie müssen sich beim NetApp Support anmelden.)
* https://[]
