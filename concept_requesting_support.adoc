...
NOTE: Sie müssen sich registrieren, um  support entitlement and accessing support,Aktivieren Sie den Support Für NetApp Cloud-Produkte. Registrieren Sie sich unter NetApp link:https://register.netapp.com["Support-Registrierung Für Cloud-Datenservices"].
