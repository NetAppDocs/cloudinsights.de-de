...
. Wenn Sie den Collector iangehalten haben, bevor Sie diese Schritte ausführen, müssen Sie Folgendes tun link:task_add_collector_svm.html#play-pause-data-collector["Nehmen Sie die Sammlung wieder auf"].
