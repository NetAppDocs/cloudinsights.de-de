...
Erfahren Sie mehr über Cloud Insights Sicherheit link:security_overview.html["Hier"].
...
. Klicken Sie auf *AObservability > Collectors > Acquisition Units > +Acquisition Unit*
+
...
. Gehen Sie in Cloud Insights zu *Observability > Collectors und wählen Sie die Registerkarte *Acquisition Units* aus.
...
. Melden Sie sich in Ihrer Cloud Insights-Umgebung an und gehen Sie zu *Observability > Collectors*.
