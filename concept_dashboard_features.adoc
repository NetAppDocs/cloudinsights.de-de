...
Die bedingte Formatierung wird für jede Spalte in einer Tabelle separat festgelegt. Beispiel: Sie können einen Satz von Schwellenwerten für eine Spalte Kapazität und einen anderen Satz für eine Durchsatzspalte wählen.
