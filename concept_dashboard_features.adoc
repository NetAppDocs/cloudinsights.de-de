...
image:Expression Example.png["Ausdruck in einem TabellenWidget"]
...
NOTE: Bedingte Formatierung ist derzeit in der Cloud Insights Bundesausgabe nicht verfügbar.
...
NOTE: Da NetApp BlueXP über eine eigene Zeitüberschreitung für die Benutzeranmeldung von 7 Tagen verfügt, muss sich Cloud Insights auch bei diesem Ereignis abmelden. Sie können sich einfach erneut anmelden und Ihr Dashboard wird weiterhin angezeigt.
