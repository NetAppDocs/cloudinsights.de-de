...
Klicken Sie im Cloud Insights-Menü auf *Dashboards > High-Intensive Workloads*, um sich einen Blick auf effektive und betroffene Workloads in Ihren gemeinsam genutzten Ressourcen anzusehen.

image:Impacts_Workloads_Menu.png["Menü „hohe Auslastung“"]

Cloud Insights zeigt eine Liste aller Workloads an, bei denen eine Sättigung erkannt wurde. Klicken Sie auf einen Workload, um das Workload-Dashboard zu öffnen.

image:Impacts_High_Consuming_Workloads.png["Liste Der Workloads"]
