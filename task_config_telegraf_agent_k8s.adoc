...
[[nkmoversion]]
.Voraussetzungen:
* Beachten Sie bitte die folgenden Komponentenversionen. Diese aktuellen Versionen sind in dem NetApp Kubernetes Monitoring Operator enthalten. Diese Versionen müssen Sie besonders beachten, wenn Sie sind <<using-a-custom-or-private-docker-repository,Verwenden eines benutzerdefinierten oder privaten Docker Repositorys>>:
+
** Telegraf: 1.24.0
** kube-rbac-Proxy: V1.13.0
