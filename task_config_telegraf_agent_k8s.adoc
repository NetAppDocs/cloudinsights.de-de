...
| Meine kubernetes-Ereignisse berichteten unerwartet nicht mehr an Cloud Insights. | Rufen Sie den Namen des Event-Exporteur Pod `kubectl -n netapp-Monitoring get Pods ab 


| Grep Event-Exporteur | awk '{Print} 1' 
|===
