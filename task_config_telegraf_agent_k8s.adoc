...
* Wenn Cloud Insights den Back-End-Storage überwacht und Kubernetes bei der Laufzeit des Docker Containers verwendet wird, kann Cloud Insights Pod-zu-PV-zu-Storage-Zuordnungen für NFS und iSCSI anzeigen. Andere Runtimes zeigen nur NFS an.
...
>>>>>>> E64b5299cf9e0451417037778f9d37b84b9d9e6b * der Host, den Sie für die Installation des NetApp Kubernetes Monitoring Operator verwenden werden, muss für die Kommunikation mit dem Ziel-K8s-Cluster _kubectl_ konfiguriert haben und über eine Internetverbindung zu Ihrer Cloud Insights-Umgebung verfügen. Wenn für diesen Host ein Proxy erforderlich ist, um Cloud Insights zu erreichen, befolgen Sie die Anweisungen im <<configuring-proxy-support,Proxy-Unterstützung Wird Konfiguriert>> Abschnitt.
