...
Beachten Sie, dass, wenn Sie _ hinzufügen<</task_add_collector_svm.html#permissions-when-adding-via-cluster-management-ip,CSuser>>_, dieser Benutzer benötigt SSH-Zugriff auf ONTAP.
